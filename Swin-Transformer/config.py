...
# Swin RoPE parameters
_C.MODEL.SWIN_ROPE = CN()
_C.MODEL.SWIN_ROPE.THETA = 10
_C.MODEL.SWIN_ROPE.MIXED = True
_C.MODEL.SWIN_ROPE.RPB = False

# Swin Cope parameters
_C.MODEL.SWIN_COPE = CN()
_C.MODEL.SWIN_COPE.N_POSMAX = 10
_C.MODEL.SWIN_COPE.K = 1
_C.MODEL.SWIN_COPE.Q = 0
_C.MODEL.SWIN_COPE.V = 0

# Swin Cope2d parameters
_C.MODEL.SWIN_COPE2D = CN()
_C.MODEL.SWIN_COPE2D.N_POSMAX = 10
_C.MODEL.SWIN_COPE2D.K = 1
_C.MODEL.SWIN_COPE2D.Q = 0
_C.MODEL.SWIN_COPE2D.V = 0
