...
python3 -m torch.distributed.launch --nproc_per_node=1 --use_env main.py --model cope_2d_v2_deit_small_patch16_LS --data-path ../data/tiny-imagenet-200/ --output_dir ../save/[new]2d-cope+ape+k/ --data-set TINY --batch-size 128 --epochs 400 --input-size 64 --wandb-project Rope-2D-tiny --wandb-name "[new]2d cope+ape+k"
